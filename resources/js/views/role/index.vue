  ...
  <div class="app-container">
    ...
    <el-scrollbar>
      ...
      >
        ...
        <el-table-column label="创建时间" prop="create_time" align="center" sortable></el-table-column>
        <el-table-column label="修改时间" prop="update_time" align="center" sortable></el-table-column>
        <el-table-column
          label="操作"
          align="center"
      ...
      <template>
        <el-form ref="form" :model="form.fields" :rules="form.rules" label-width="100px">
          <el-form-item label="角色名" prop="name">
            <el-input placeholder="请输入角色名" v-model="form.fields.name"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleUpdate(scope) {
      ...
      let permissions = []
      for (let permission of scope.row.permissions) {
    ...
    handleTreeChecked(Tree, nodeKey) {
      let checkedNode = Tree.getNode(nodeKey)

      let recursiveChildrenChecked = (node) => {
      ...
      let recursiveParentChecked = (node) => {
      ...
      let isAllChildrenNoChecked = (parentNode) => {
        let checkedCount = 0
